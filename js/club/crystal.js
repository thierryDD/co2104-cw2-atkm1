$(document).ready(function() {
    ...
    var crystalPalaceGames = [
        ...
        { date: "October 29, 2024", teams: "Queens Park Rangers vs. Crystal Palace", location: "Kiyan Prince Foundation Stadium", match: "FA" },
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, crystalPalaceGames)
        buildTable(data)
    })


    buildTable(crystalPalaceGames)
