$(document).ready(function() {
    ...
    var millwallGames = [
        ...
        { date: "January 11, 2025", teams: "QPR vs. Millwall", location: "Loftus Road Stadium", match: "Championship League" }
    ];
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, millwallGames)
        buildTable(data)
    })


    buildTable(millwallGames)
