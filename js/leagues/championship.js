$(document).ready(function() {
    ...
    var championship = [
        { date: "August 10, 2024", teams: "Millwall vs. Watford", location: "The Den, London" },
        { date: "August 17, 2024", teams: "QPR vs. Birmingham", location: "Loftus Road Stadium, London" },
        { date: "September 1, 2024", teams: "Millwall vs. QPR", location: "The Den, London" },
        { date: "January 11, 2025", teams: "QPR vs. Millwall", location: "Loftus Road Stadium, London" }
    ]
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, championship)
        buildTable(data)
    })


    buildTable(championship)
