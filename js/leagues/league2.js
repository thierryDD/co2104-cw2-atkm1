$(document).ready(function() {
    ...
    var league2 = [
        {
            ...
            teams: "Sutton United vs. Crewe",
            location: "Gander Green Lane",
            league: "League 2"
        },
        {
            date: "September 7, 2024",
            teams: "AFC Wimbledon vs. Bradford City",
            location: "Plough Lane",
            league: "League 2"
        },
        {
            date: "September 14, 2024",
            teams: "AFC Wimbledon vs. Barrow",
            location: "Plough Lane",
            league: "League 2"
        },
        {
            date: "September 28, 2024",
            teams: "AFC Wimbledon vs. Newport County",
            location: "Plough Lane",
            league: "League 2"
        },
        {
            date: "October 12, 2024",
            teams: "AFC Wimbledon vs. Sutton United",
            location: "Plough Lane",
            league: "League 2"
        },
        {
            date: "October 12, 2024",
            teams: "AFC Wimbledon vs. Gillingham",
            location: "Plough Lane",
            league: "League 2"
        }
    ]
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, league2)
        buildTable(data)
    })
