$(document).ready(function() {
    ...
    var league1 = [
        { date: "August 10, 2024", teams: "Leyton Orient vs. Exeter City", location: "Brisbane Road, London" },
        { date: "August 17, 2024", teams: "Charlton Athletic vs. Bolton", location: "The Valley, London" },
        {
            date: "August 24, 2024",
            teams: "Leyton Orient vs. Bristol Rovers",
            location: "Brisbane Road, London" },
        {
            date: "September 7, 2024",
            teams: "Charlton Athletic vs. Fleetwood Town",
            location: "The Valley, London"
        },
        {
            date: "September 14, 2024",
            teams: "Leyton Orient vs. Northampton",
            location: "Brisbane Road, London"
        },
        {
            date: "September 21, 2024",
            teams: "Charlton Athletic vs. Derby",
            location: "The Valley, London"
        },
        {
            date: "October 5, 2024",
            teams: "Leyton Orient vs. Peterborough",
            location: "Brisbane Road, London"
        },
        {
            date: "October 19, 2024",
            teams: "Leyton Orient vs. Wycombe",
            location: "Brisbane Road, London"}
    ]
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, league1)
        buildTable(data)
    })
