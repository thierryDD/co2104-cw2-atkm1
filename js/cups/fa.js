$(document).ready(function() {
    ...
    var fa = [
        {
            date: "August 12, 2024",
            teams: "Arsenal vs. Leeds",
            location: "Emirates Stadium",
            match: "FA"
        },
        {
            date: "August 15, 2024",
            teams: "Chelsea vs. Middlesbrough",
            location: "Stamford Bridge",
            match: "FA"
        },
        {
            date: "August 19, 2024",
            teams: "Brentford vs. Norwich City",
            location: "Brentford Community Stadium",
            match: "FA"
        },
        {
            date: "October 26, 2024",
            teams: "Crystal Palace vs. Stockport",
            location: "Selhurst Park",
            match: "FA"
        },
        {
            date: "October 27, 2024",
            teams: "AFC Wimbledon vs. Southampton",
            location: "Plough Lane",
            match: "FA"
        },
        {
            date: "October 29, 2024",
            teams: "Queens Park Rangers vs. Lincoln City",
