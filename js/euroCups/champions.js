$(document).ready(function() {
    ...
    var championsl = [
        ...
        { date: "December 01, 2024", teams: "Arsenal vs. Sevilla", location: "Emirates Stadium", match: "Champions League" },
        { date: "January 20, 2025", teams: "Arsenal vs. PSV", location: "Emirates Stadium", match: "Champions League" }
    ]
    ...
    $('#search-input').on('keyup', function(){
        ...
        var data = searchTable(value, championsl)
        buildTable(data)
    })


    buildTable(championsl)
